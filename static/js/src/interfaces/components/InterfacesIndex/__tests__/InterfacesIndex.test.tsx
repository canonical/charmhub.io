...
describe('InterfacesIndex', () => {
  const interfacesList: InterfaceItem[] = [
    { name: 'interface1', description: 'Description 1', version: '1.0', status: 'test', category: 'Category 1' },
    { name: 'interface2', description: 'Description 2', version: '1.1', status: 'beta', category: 'Category 2' },
    { name: 'interface3', description: 'Description 3', version: '1.2', status: 'beta', category: 'Category 3' },
  ];
  ...
  test('handles pagination correctly', async () => {
    const longerInterfacesList: InterfaceItem[] = Array(5).fill(interfacesList).flat();
