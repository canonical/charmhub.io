...
describe("InterfaceDetailsLinks", () => {
  ...
  test('renders "Submit a bug" link with correct href when isCommunity is false', () => {
    ...
    expect(submitBugLink).toHaveAttribute(
      "href",
      "https://github.com/canonical/charm-relation-interfaces/issues/new?title=testInterface+1.0"
    );
  ...
  test('renders "Submit a bug" link with correct href when isCommunity is true', () => {
    ...
    expect(submitBugLink).toHaveAttribute(
      "href",
      "https://github.com/canonical/charm-relation-interfaces/issues/new?title=(Untested)+testInterface+1.0"
    );
  ...
  test('renders "Specification archive" link with correct href when isCommunity is false', () => {
    ...
    const specificationArchiveLink = screen
      .getByText("Specification archive")
      .closest("a");
    expect(specificationArchiveLink).toHaveAttribute(
      "href",
      "https://github.com/canonical/charm-relation-interfaces/tree/main/interfaces/testInterface"
    );
  ...
  test("renders with no interface version", () => {
    ...
    expect(submitBugLink).toHaveAttribute(
      "href",
      "https://github.com/canonical/charm-relation-interfaces/issues/new?title=testInterface"
    );
